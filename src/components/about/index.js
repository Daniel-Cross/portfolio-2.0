	...
	return (
		<div id="About">
			...
			<div className="personal">
				<p>
					I'm a Junior Front-End JavaScript Developer with detail-oriented nature. Learnt best practices and
					agile methodologies at Manchester Codes Academy where technologies taught include JavaScript, Node,
					React, Express and MongoDB. Previously worked at BookingGo and Degree53 as a full-time developer
			...
			<div className="skills">
				<div className="skill">
					<h2>Development</h2>
					<p>
						JavaScript, React, Node.js, Express.js, MongoDB, Sass/Scss, HTML5, CSS3 and various UI
						frameworks.
					</p>
				</div>
				<div className="skill">
